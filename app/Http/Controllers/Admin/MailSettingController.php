...
class MailSettingController extends Controller
{
    ...
    public function update(Request $request, MailSettings $settings)
    {
        $validated = $request->validate([
            ...
            "password"        => "required_if:provider,smtp|string|nullable",

            // Mailgun
            "mailgun_domain"  => "required_if:provider,mailgun|string|nullable",
            "mailgun_secret"  => "required_if:provider,mailgun|string|nullable",
            "mailgun_endpoint"=> "nullable|string",

            // Resend
            "resend_key"      => "required_if:provider,resend|string|nullable",
        ]);
